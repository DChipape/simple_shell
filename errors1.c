...
/**
 * _erratoi - change the string to an integer
 * @s: The input string to change
*
 * Return: a changed integer for valid, else returns -1 on error
 */
...
/**
 * print_error - lists the custom error message
 * @info: Structure holding the parameter & return info
 * @estr: an error message to print
...
/**
 * print_d - lists a decimal (integer) number (base 10)
...
/**
 * convert_number - change the number to a specified base
...
/**
 * remove_comments - function replaces first example of '#' with '\0'
