...
/**
 * write_history - Writes the shell's history to a file.
 * @info: The parameter struct containing shell information.
 *
...
/**
 * read_history - Reads the shell's history from a file.
 * @info: The parameter struct containing shell information.
 *
...
/**
 * build_history_list - Adds an entry to the shell's history linked list.
 * @info: The parameter struct containing shell information.
