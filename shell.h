...
/**
 * struct liststr – there singly linked list
 * @num: there number field
 * @str: a string
 ...
 *@env: there linked list local copy of environ
 ...
 *@readfd: there fd from which to read line input
 *@histcount: there history line number count
 */
