 ...
 * @hd: There head of the linked list.
 * @inp: There input string.
 * @shell_data: There data structure.
 *
 * Return: Always 0
 */
 ...
 * @hd: There head of the linked list.
 * @inp: there input string.
 * @new_inp: New input string (restored).
 * @numlen: There new length.
 *
 ...
 * @header: There head of the linked list.
 * @inp: there input string.
 * @str: Last stature of the shell.
